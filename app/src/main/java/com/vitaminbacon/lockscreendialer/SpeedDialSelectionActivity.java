...
public class SpeedDialSelectionActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("SpeedDialSelectionActivity.onCreate()", "inflated Content View.");

        // TODO: modify any keys that have already been assigned
    }
    ...
    public void assignSpeedDialContact (View view) {
        ...
        Log.d("assignSpeedDialContact()", "button " + button.getText().toString() + " pressed.");
